...
export default function SixWeeks({ navigation }) {
  return (
...
<Image source={require('./Images/Logo.png')} style={styles.logo} />
      ...
      <View style={styles.card}>
        <Image source={require('./Images/Garden.jpg')} style={styles.image} />
        <Text style={styles.courseName}>Course Name</Text>
        <Text style={styles.courseDetail}>Garden maintenance</Text>
      ...
      <View style={styles.card}>
        ...
        <TouchableOpacity 
          onPress={() => {
            ...
            navigation.navigate('Cooking'); // Ensure the name matches
          }} 
        >
          <Text style={styles.link}>Cooking</Text>
        </TouchableOpacity>
        <TouchableOpacity 
          onPress={() => {
            console.log("Navigating to ChildMinding");
            navigation.navigate('ChildMinding'); // Ensure the name matches
          }} 
        >
          <Text style={styles.link}>ChildMinding</Text>
        </TouchableOpacity>
        <TouchableOpacity 
          onPress={() => {
            console.log("Navigating to Garden Maintence");
            navigation.navigate('Garden Maintence'); // Ensure the name matches
          }} 
        >
          <Text style={styles.link}>Garden Maintence</Text>
        </TouchableOpacity>
      </View>
      <View style={styles.card}>
